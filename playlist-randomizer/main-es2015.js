...
const API_KEY = 'AIzaSyDBzQxWYjwQmF9jbU_Mm5JTXUwSvX6Oipw';
...
/* harmony import */ var safe_pipe__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! safe-pipe */ "./node_modules/safe-pipe/index.js");
/* harmony import */ var safe_pipe__WEBPACK_IMPORTED_MODULE_9___default = /*#__PURE__*/__webpack_require__.n(safe_pipe__WEBPACK_IMPORTED_MODULE_9__);
/* harmony import */ var _angular_youtube_player__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! @angular/youtube-player */ "./node_modules/@angular/youtube-player/esm2015/youtube-player.js");
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        ...
        imports: [
            ...
            safe_pipe__WEBPACK_IMPORTED_MODULE_9__["SafePipeModule"],
...
/* harmony import */ var api_key__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! api_key */ "./api_key.ts");
...
let HomeComponent = class HomeComponent {
    ...
    search() {
        ...
        if (this.input.length === 34 && this.input.split(' ').length === 1) {
            this.getPlaylist().subscribe((res) => this.playlistsFound = res.items);
        }
        else {
            this.http.get('https://www.googleapis.com/youtube/v3/search', { params }).subscribe((res) => this.playlistsFound = res.items);
        }
    }
    get input() {
...
/* harmony import */ var api_key__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! api_key */ "./api_key.ts");
...
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])("player", { static: null })
...
module.exports = __webpack_require__(/*! C:\Users\vitor\Desktop\b\src\main.ts */"./src/main.ts");
